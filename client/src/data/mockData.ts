...
export const MOCK_PROPERTIES: Property[] = [
  {
    ...
    phone: '+91 80 2572 8899',
    email: 'hsr.pearl@urbannest.in',
    totalRooms: 12,
    totalBeds: 36,
    occupiedBeds: 31,
    monthlyRevenue: 558000,
    upiId: 'urbannest.pearl@icici',
    gstNumber: '29AABCU9639R1ZM',
